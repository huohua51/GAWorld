...
Audited on 2026-07-11 (Asia/Shanghai). This ledger freezes the evidence used by
...
| S-FULL-PLUGIN-MIGRATION | DESIGNED | `docs/proposals/2026-07-11-microkernel-plugin-architecture.md` plus the partial runtime paths above | The proposal specifies a broader plugin architecture; the manuscript must not describe every subsystem as fully migrated. |
...
| E-ECON | COMPLETE | `docs/proposals/results/exp_macro_economy/run_42/state/agent_state_history.csv`; `wellbeing_report.md` | Demonstrate a 5-agent, 3-day, 11,600-row long-format state trace (20 metrics × 580 steps per agent) and derived descriptive summaries. It is one seeded run, not evidence about people, economies, or policies. |
...
| E-BENCH | `benchmark/results/scorecard.json` | `ebbae2eeccd952953b1a623e7ee543d03bf42c44b33417a91672ec270b523223` |
...
| Claim | Path | SHA-256 |
|---|---|---|
| S-KERNEL | `gaworld/kernel/context.py` | `e5f9e38ba24d01bc1c68bd010ed6449866d47bd86be46acb928c7585d521052e` |
