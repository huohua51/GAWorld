...
Life events & Persisted event queue, clock & Consumption flag and configured state effects & Scheduled exogenous changes to targeted agents & Implemented; plugin migration unclaimed \\
...
plugin entry points, and the economy uses lifecycle hooks, but memory, world,
social, and work paths still exchange mutable agent dictionaries or runtime
objects directly.  This arrangement is usable and inspectable, yet replacing
